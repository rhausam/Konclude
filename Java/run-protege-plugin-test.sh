...
FAILED_SCENARIOS=""
for scenario in plugin hierarchy expressions individuals properties datatypes inconsistency unsupported lifecycle merges timeout entailment interrupt; do
	echo
	echo "--------------------------------------------------------------------------"
