...
namespace Konclude {
	...
	namespace Scheduler {
		...
		CTaskProcessorSchedulerThread::CTaskProcessorSchedulerThread(CTaskHandleAlgorithm* taskHandleAlgo, CTaskEventHandlerBasedDistributionCompletor* distributorCompletor, CConsiderateMemoryPoolProvider* memoryPoolProvider, cint64 freePoolReserveLimit) : CTaskProcessorThreadBase(taskHandleAlgo,"TaskProcesserSchedulerThread") {
