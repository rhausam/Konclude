...
namespace Konclude {
	...
	namespace Scheduler {
		...
		class CTaskProcessorCompletorThread : public CTaskProcessorThreadBase, public CConcreteMemoryPoolDistributor, virtual public CTaskEventHandlerBasedDistributionCompletor {
			...
			public:
				//! Constructor
				CTaskProcessorCompletorThread(CTaskHandleAlgorithm* taskHandleAlgo, CConsiderateMemoryPoolProvider* memoryPoolProvider = nullptr, cint64 freePoolReserveLimit = DEFAULT_FREE_POOL_RESERVE_LIMIT);
