			...
			class CAnsweringMessageDataCalculationAdapter : public CAnsweringMessageData {
				...
				public:
					...
					enum CALCULATIONADAPTERTYPE {
						CLASSSUBSUMERS, POSSIBLECLASSSUBSUMERS, PROPAGATION_BINDINGS, INSTANCE_CERTAIN_PROPAGATIONS, INSTANCE_POSSIBLE_PROPAGATIONS, MATERIALIZED_CONCEPTS, ROOTLABEL
					};
